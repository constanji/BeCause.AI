...
const { agentSchema } = require('@because/data-schemas');
...
/**
 * @type {import('mongoose').Model<import('@because/data-schemas').IAgent>}
 */
let Agent;
...
describe('models/Agent', () => {
  ...
  describe('Agent CRUD Operations', () => {
    ...
    test('should handle ephemeral agent loading', async () => {
      ...
      const originalModule = jest.requireActual('@because/data-provider');
      ...
      jest.doMock('@because/data-provider', () => mockDataProvider);

      expect(agentId).toBeDefined();
      expect(endpoint).toBeDefined();

      jest.dontMock('@because/data-provider');
    });
  ...
  describe('Load Agent Functionality', () => {
    ...
    test('should test ephemeral agent loading logic', async () => {
      const { EPHEMERAL_AGENT_ID } = require('@because/data-provider').Constants;
