...
import { TooltipAnchor, Button, NewChatIcon, useMediaQuery } from '@because/client';
import { PermissionTypes, Permissions, QueryKeys } from '@because/data-provider';
...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  // Set page title
  useDocumentTitle(`${localize('com_agents_marketplace')} | Because`);
